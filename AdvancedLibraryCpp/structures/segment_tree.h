...
using range_sum_t = range_operation_t<T, tools::sum_t<T>, update_t>;

template<class T, typename update_t = empty_update_t>
using range_multiplication_t = range_operation_t<T, tools::multiplication_t<T>, update_t>;

template<class T, typename update_t = empty_update_t>
using range_min_t = range_operation_t<T, tools::minimum_t<T>, update_t>;

template<class T, typename update_t = empty_update_t>
using range_max_t = range_operation_t<T, tools::maximum_t<T>, update_t>;
